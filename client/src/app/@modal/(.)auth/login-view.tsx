  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          variant="outline"
          className="w-full h-12 text-sm font-medium border-2 hover:bg-red-50 hover:border-red-200 transition-colors bg-transparent rounded-full"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2">
          ...
          <Button
            className="mt-1 w-full py-5 rounded-full"
            disabled={signInWithEmailMutation.isPending}
          >
