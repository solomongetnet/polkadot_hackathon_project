...
import NftMintingModal from "./nft-minting";
...
const UserCharactersContainer = () => {
  ...
  const [selectedIdToMint, setSelectedIdToMint] = useState(null);
  ...
  return (
    <>
        ...
        {allCharacters.map((character) => (
          ...
          >
            ...
            <div className="flex gap-2">
              <Button
                onClick={() => {
                  setSelectedIdToMint(character.id);
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    variant={"outline"}
                    disabled={
                      updateCharacterVisibilityMutation.variables
      ...
      <NftMintingModal
        ...
        characterId={selectedIdToMint!}
        setSelectedIdToMint={setSelectedIdToMint}
      />
    </>
  );
};
