...
import { NewCharacterInput } from "./validator";
...
const ThemeModal = ({
  ...
  watch: UseFormWatch<NewCharacterInput>;
  disabled: boolean;
}) => {
        ...
        >
          ...
          <div className="flex gap-2 items-center">
            <span
              ...
              style={{
                background: `linear-gradient(135deg, ${appliedTheme.userColorHex} 50%, ${appliedTheme.aiColorHex} 50%)`,
              }}
            />
